...
window.app = new Vue({
	...
	data: {
		...
		'-------------',
		'USA (3039626)','Brazil (1626071)','India (720346)','Russia (687862)','Peru (305703)','Spain (298869)','Chile (298557)','UK (285768)','Italy (241819)','South Africa (205721)','Germany (198057)','Colombia (120281)','Canada (105934)','China (83557)','Belgium (62016)','Netherlands (50657)','Switzerland (32315)','Ireland (25531)','Austria (18365)','Czechia (12566)','Australia (10233)','Estonia (1994)','Slovenia (1716)',
		'-------------',
		'England','Scotland','Wales','Mexico','Panama','Poland',
		'-------------',
