...
window.app = new Vue({
	...
	data: {
		...
		'USA','Brazil','Russia','India','UK','Chile','Peru','Mexico','Panama','South Africa','China','Italy','Germany','Spain','Sweden','Belgium','Netherlands','Austria','Canada','Australia','England','Scotland','Wales','-------------',
		'London','Lima','-------------'
		,'Governance'
		,'-------------',
		'Locations'],
