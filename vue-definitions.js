...
window.app = new Vue({
	...
	data: {
		...
		'USA','Brazil','Russia','India','UK','Chile','Peru','Mexico','South Africa','China','Italy','Germany','Belgium','Spain','Netherlands','Austria','Canada','Australia','England','Scotland','Wales','-------------',
		'London','Lima','-------------'
		,'Governance'
		,'-------------',
		'Locations'],
